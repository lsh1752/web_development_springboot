...
SELECT price, discount_price 
	FROM PRODUCTS 
	LIMIT 10;
-- SQL문의 경우ㅇ는 순서가 매우 명확하게 정해져있는 편이기 때문에
-- 읽기는 쉽지만 익숙해지기 전까지 직접 작성하는 것이 까다로운 편

-- orderdetails의 모든 정보 표시하세요
SELECT * FROM ORDERDETAILS;
-- 회원 정보 테이블 users에서 상위 7건만 표시하세요.(전부다)
