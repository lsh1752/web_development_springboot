...
/*
    1. 사전 지식 : API와 REST API
        ...
        식당으로 알아보는 API
            여러분이 손님인데, 식당 들어감 -> 점원에게 요리를 주문합니다(주방으로 가서 요리를 주문하는게 아니라).
            그리고 점원은 주방에 가서 요리를 만들어달라고 요창합니다.
                 요 청       요 청
            손님 <----> 점원 <----> 주방
                 응 답       응 답
             ...
             우리는 웹 사이트의 주소를 입력해서 '구글 메인 화면을 보여줘'라고 요청하면, API는 이 요청을 받어서 서버에게 전달.
            ...
            웹의 장점을 최대한 활용하는 형태라고 알려진 REST API
                ...
                장점:
                    ...
                    무상태 특징으로 인해 클라이언트아ㅘ 서버의 역할이 명확하게 분리됨.
                ...
                REST SPI를 사용하는 방법
                    규칙 11. URL에는 동사를 쓰지 말고, 자원을 표시한다.
