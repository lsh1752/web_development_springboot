...
@AutoConfigureMockMvc   // MockMvc 생성 및 자동 ㄱ성
class BlogApiControllerTest {
    ...
    public void addArticle() throws Exception {
        ...
        /*
            List에서 <> 제네릭 Article 클래스의 객체를 요소로 답게됩니다.
            List 주요 메서드
            ...
            writeValueAsString() 메서드 : 겍체를 JSON으로 직렬화.
    ...
    public void deleteArticle() throws Exception {
        ...
        // when     - CR 과 다른 점이 하나 있습니다.
        mockMvc.perform(delete(url, savedArticle.getId()))// findArticle() 처럼 하나의 객체를 대상으로 할 때는 argument 가 url 만 있는게 아닙니다ㅏ.
