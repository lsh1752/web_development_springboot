...
/*
    1. 테스트 코드 개념 익히기
        ...
        테스트 코드란?
            ...
            테스트 코드에는 다양한 패턴이 있는데, 일단 저는 geven-when-then 패턴을 사용할 예정
    ...
    2. 스프링 부트 3와 테스트
        스프링 부트는 애플리케이션을 테스트하기위한 도구와 애너테이션을 제공.
                ...
                자바 언어를 위한 *단위 테스트 프레임워크
                    *단위 테스트 : 작성한 코드가 의도대로 작동하는지 작은 단위로 검증함을 의미
                    ...
                    특징 :
                        ...
                        4) 사용 방법이 단수, 테스트 코드 작성 시간이 적습니다(익숙해지면)
    ...
    AssertJ로 검증문 가독성 높이기
        ...
        test/java 에 JUnitQuiz.java 파일 생성
 */
